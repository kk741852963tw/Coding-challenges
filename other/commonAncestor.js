...
/**
  ...
  */
Tree.prototype.getClosestCommonAncestor = function(input1, input2) {
  // TODO: implement me!
  if (input1 === input2) {
    return input1;
  } else {
    var array1 = this.getAncestorPath(input1);
    var array2 = this.getAncestorPath(input2);
    if (!array1 || !array2) {
      return null;
    }
...
/**
  ...
  */
Tree.prototype.getAncestorPath = function(input) {
  // TODO: implement me!
  if (this === input) {
    return [input];
  } else {
    ...
    var temp = this;
    var index = 0;
    while (temp.isDescendant(input) && index === 0) {
      result.push(temp);
      for (var i = 0; i < temp.children.length; i++) {
        if (temp.children[i].isDescendant(input)) {
          temp = temp.children[i];
          break;
        }
        if (i === temp.children.length - 1) {
          index = 1;
        }
      }
    }
